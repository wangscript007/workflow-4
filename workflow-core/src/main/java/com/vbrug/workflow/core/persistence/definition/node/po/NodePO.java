package com.vbrug.workflow.core.persistence.definition.node.po;
...
public class NodePO {
    ...
    private Integer childProcessId;                     // 子流程ID
    ...
    public Integer getChildProcessId() {
        return childProcessId;
    }

    public void setChildProcessId(Integer childProcessId) {
